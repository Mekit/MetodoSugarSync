...
class AccountCache extends CacheDb {
    ...
    protected $columns = [
        ...
        'metodo_client_code_imp_c' => ['type' => 'TEXT', 'index' => TRUE],
        'metodo_supplier_code_imp_c' => ['type' => 'TEXT', 'index' => TRUE],
        'metodo_client_code_mekit_c' => ['type' => 'TEXT', 'index' => TRUE],
        'metodo_supplier_code_mekit_c' => ['type' => 'TEXT', 'index' => TRUE],
        'metodo_inv_cli_imp_c' => ['type' => 'TEXT', 'index' => FALSE],
        'metodo_inv_sup_imp_c' => ['type' => 'TEXT', 'index' => FALSE],
        'metodo_inv_cli_mekit_c' => ['type' => 'TEXT', 'index' => FALSE],
        'metodo_inv_sup_mekit_c' => ['type' => 'TEXT', 'index' => FALSE],
