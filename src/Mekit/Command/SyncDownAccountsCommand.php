  ...
  protected function configure()
  {
    ...
    $this->setDefinition(
      [
        ...
        new InputOption(
          'delete-cache', '', InputOption::VALUE_NONE, 'Delete all cached data.'
        ),
        new InputOption(
          'invalidate-cache', '', InputOption::VALUE_NONE, 'Reset timestamps on local and remote cache so that updates will occur again.'
        ),
        new InputOption(
