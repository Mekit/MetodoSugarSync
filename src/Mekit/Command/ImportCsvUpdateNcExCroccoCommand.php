...
use Mekit\Sync\CsvToCrm\NcExCrocco;
use Symfony\Component\Console\Input\InputArgument;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Input\InputOption;
use Symfony\Component\Console\Output\OutputInterface;

class ImportCsvUpdateNcExCroccoCommand extends Command implements CommandInterface
{
  const COMMAND_NAME = 'import-csv:update-nc-ex-crocco';
  const COMMAND_DESCRIPTION = 'Update Accounts in csv with state from metodo';
  ...
  {
    $class = "Mekit\\Sync\\CsvToCrm\\NcExCrocco";
    /** @var NcExCrocco $dataClass */
